sap.ui.define([
	...
	return BaseController.extend("Partner.BusinessPartner.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("PartnerSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("PartnerSet", oData);
