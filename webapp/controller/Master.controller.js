...
sap.ui.define([
	...
	return BaseController.extend("Partner.BusinessPartner.controller.Master", {
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							Partnerid: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("Partnerid"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				Partnerid: encodeURIComponent(oItem.getBindingContext().getProperty("Partnerid"))
			}, bReplace);
		},
