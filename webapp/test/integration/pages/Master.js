			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.waitFor({
						...
						success: function () {
							Opa5.assert.ok(true, "The list header displays 'PartnerSet (0)'");
						},
				...
				theListShouldHaveAllEntries: function () {
					...
					// retrieve all PartnerSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "PartnerSet (" + iExpectedLength + ")"
								}),
								success: function () {
